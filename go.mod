...
require (
	...
	github.com/cloudwego/eino-ext/components/model/claude v0.0.0-20250514085234-473e80da5261
...
replace github.com/invopop/jsonschema => github.com/currybab/jsonschema v0.0.0-20250429080118-779849695a6f
